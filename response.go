...
type finalResponse struct {
	...
	// isEmpty indicates that this response should not be send
	isEmpty bool
}
...
func createPartialResponse() partialResponse {
	return partialResponse{
		current: &bytes.Buffer{}, // TODO: is this correct?
...
func (r *finalResponse) shouldReplaceBuffers(buf *textproto.Conn) *finalResponse {
	r.bufReplacement = buf
	return r
}
